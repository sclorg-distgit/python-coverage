...
- Moved the license text to %%doc due to %%license macro not working properly
  in RHSCLs with respect to package uninstallation. (rhbz#1334670)

* Mon Jan 16 2017 Tomas Orsava <torsava@redhat.com> - 3.6-2
- Added the license text to %%license

* Thu Nov 07 2013 Robert Kuska <rkuska@redhat.com> - 3.6-1
- Update to 3.6 final

* Thu Oct 24 2013 Robert Kuska <rkuska@redhat.com> - 3.5.3-3
- Bump release number to avoid rhel-7.0 build conflict
